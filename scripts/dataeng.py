...
# save data
np.savetxt(_data_dir + "/X_train_small.csv", x_train_small, delimiter=",")
np.savetxt(_data_dir + "/Y_train_small.csv", y_train_small, delimiter=",")
np.savetxt(_data_dir + "/X_test_small.csv", x_test_small, delimiter=",")
np.savetxt(_data_dir + "/Y_test_small.csv", y_test_small, delimiter=",")
